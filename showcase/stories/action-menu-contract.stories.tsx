    ...
    docs: {
      description: {
        story:
          ...
          "соседними действиями и только там (action-menu.tsx:86, :112), групп " +
    ...
    docs: {
      description: {
        story:
          ...
          "(action-menu.tsx:76, :98, решение DEC-011). Вызов на цвет " +
  ...
  parameters: {
    silence: {
      ...
      text:
        ...
        "(action-menu.tsx:12, :16, :51-61): пункт затенён, подсказка " +
        "появляется при наведении. Контракт при этом молчит — раздел 4 " +
        "не описывает ни вид запрещённого пункта, ни когда подсказка " +
        "обязательна. Проверять нечего, потому что правила нет, " +
        "а не потому, что компонент чего-то не умеет. Вопрос заведён: " +
        "Q-024.",
    },
    docs: {
      description: {
